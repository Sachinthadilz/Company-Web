        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
              End-to-end digital solutions from concept to launch, tailored to your unique business needs.
            </p>
          </motion.div>
          ...
          <div className="text-center mt-12">
            <Link
              to="/services"
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-gradient-to-br from-primary to-secondary text-white font-semibold rounded-xl hover:opacity-90 hover:scale-105 transition-all shadow-lg"
            >
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link
              to="/projects"
              className="inline-flex items-center gap-2 px-8 py-3.5 border-2 border-primary text-primary dark:border-blue-400 dark:text-blue-400 font-semibold rounded-xl hover:bg-gradient-to-br hover:from-primary hover:to-secondary hover:text-white hover:border-transparent transition-all"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-slate-500 dark:text-slate-400 mb-8 leading-relaxed">
                We combine technical excellence with deep business understanding to deliver solutions that don't just work — they drive results.
              </p>
