...
const team = [
  {
    ...
    role: 'Founder & CEO',
    image: 'https://ambitious-moss-013648c10.1.azurestaticapps.net/assets/tharindu-DibtzlDi.jpg',
    category: 'Leadership',
  },
  {
    name: 'Sahan Abeysinghe',
    role: 'CTO',
    image: 'https://ambitious-moss-013648c10.1.azurestaticapps.net/assets/Sahan-Wiw6tFoc.jpg',
    category: 'Leadership',
  },
  {
    name: 'Imath De Silva',
    role: 'Director',
    image: 'https://ambitious-moss-013648c10.1.azurestaticapps.net/assets/imath-CacIxrkp.jpg',
    category: 'Leadership',
  },
  {
    name: 'Dinithi Gamage',
  ...
  },
  {
    ...
    image: 'https://ambitious-moss-013648c10.1.azurestaticapps.net/assets/Frontend-Mobile-jfUpC_cy.jpeg',
    category: 'Team Leads',
  },
  {
    name: 'Dilmi Kavishka',
    role: 'Frontend Web',
    image: 'https://ambitious-moss-013648c10.1.azurestaticapps.net/assets/Frontend-Web-D_FMaMFd.jpeg',
    category: 'Team Leads',
  },
  {
    name: 'Pathum Sankalpa',
    role: 'Backend',
    image: 'https://ambitious-moss-013648c10.1.azurestaticapps.net/assets/Backend-Lead-vaegYnvh.jpeg',
    category: 'Team Leads',
  },
  {
  ...
  },
  {
    ...
    role: 'R&D',
    image: 'https://ambitious-moss-013648c10.1.azurestaticapps.net/assets/R_D-Lead-DYC_l-9o.jpeg',
    category: 'Team Leads',
  },
  {
    name: 'Nishitha Nishadi',
    role: 'QA',
    image: 'https://ambitious-moss-013648c10.1.azurestaticapps.net/assets/QA-Lead-BsKK55q2.jpeg',
    category: 'Team Leads',
  },
  {
    name: 'Sasun Madhuranga',
    role: 'AI & ML',
    image: 'https://ambitious-moss-013648c10.1.azurestaticapps.net/assets/AI-Lead-DTvnzSLA.jpeg',
    category: 'Team Leads',
  },
];
...
const About = () => {
  ...
  useEffect(() => {
    fetch(`${API_BASE}/employee-of-month`)
      .then((r) => r.json())
      .then((d) => { if (d.success) setEomList(d.data.filter((e: EOM & { active: boolean }) => e.active)); })
      .catch(() => {});
  }, []);

  const values = [
    { icon: Target, title: 'Mission', desc: "We're building for People — making everyday workflows simpler, smarter, and more human." },
    { icon: Eye, title: 'Vision', desc: 'To bring complex workflows into focus with design that empowers every user journey.' },
    { icon: Heart, title: 'Values', desc: 'Customer First, Innovation, Integrity, and Passion guide everything we build.' },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-6">
                From Startup to <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Industry Leader</span>
              </h2>
              <div className="space-y-4 text-slate-600 dark:text-slate-400 leading-relaxed">
                <p>
                  ARTecX Solutions was founded in 2020 by three founders sharing a single garage and a whiteboard, driven by the belief that technology should be built for people.
                </p>
                <p>
                  By 2022, we hit a massive milestone: 1 million active users across the platforms we designed. We've scaled products that reach millions while maintaining the personal attention of a three-person shop.
                </p>
                <p>
                  Today, we continue to design systems that scale, bringing complex workflows into focus to empower every user journey.
                </p>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-2 gap-5">
              {[
                ...
                >
                  ...
                  <div className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary mb-1">{value}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-4">
              What Drives <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Us</span>
            </h2>
          </div>
      ...
      <section className="py-20 bg-white dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-4">
              The People Behind <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">ARTecX</span>
            </h2>
          </div>
          ...
          {activeCategory === 'Employee Of The Month' && (
            eomList.length === 0 ? (
              <div className="text-center py-16 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700">
                <Star size={40} className="text-slate-300 dark:text-slate-600 mx-auto mb-4" />
                <p className="text-slate-500 dark:text-slate-400">No Employee of the Month records yet.</p>
              </div>
            ) : (
                ...
                {eomList.map((emp, i) => (
                  ...
                  >
                    ...
                    <div className="p-6 text-center">
                      ...
                      <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-1">{emp.name}</h3>
                      <p className="text-secondary dark:text-blue-400 text-sm font-semibold mb-3">{emp.role}</p>
                      {emp.bio && <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-3">{emp.bio}</p>}
                      {emp.quote && (
          ...
          {activeCategory !== 'Employee Of The Month' && (
            team.filter(member => member.category === activeCategory).length === 0 ? (
              <div className="text-center py-16 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-700">
                <Users size={40} className="text-slate-300 dark:text-slate-600 mx-auto mb-4" />
                <p className="text-slate-500 dark:text-slate-400">No team members match this category right now.</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {team.filter(member => member.category === activeCategory).map((member, i) => (
                  <motion.div
                    key={member.name}
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    ...
                    <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-1">{member.name}</h3>
                    <p className="text-secondary dark:text-blue-400 text-sm font-semibold mb-2">{member.role}</p>
                  </motion.div>
                ))}
              </div>
            )
